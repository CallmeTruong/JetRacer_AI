...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='datasets/urban_traffic/multitask_dataset', help='Primary raw image dataset folder')
    parser.add_argument('--move_controller_dir', type=str, default='datasets/urban_traffic/classification', help='Move controller free/blocked dataset folder')
    parser.add_argument('--output_dir', type=str, default='datasets/urban_traffic/multitask_dataset', help='Dedicated labeled output dataset folder')
